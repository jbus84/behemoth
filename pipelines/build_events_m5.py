...
def build_dataset():  # pragma: no cover
    ...
    if len(all_events) > 0:
        ...
        out_path = os.path.join(OUTPUT_DIR, "events_m5_8yr_v3_dual.csv")
        ...
        out_mom = os.path.join(OUTPUT_DIR, "events_m5_8yr_v3_mom.csv")
        out_rev = os.path.join(OUTPUT_DIR, "events_m5_8yr_v3_rev.csv")
