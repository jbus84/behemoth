...
PAIRS = [
    # FX & Commodities
    ("EUR/GBP", "EURUSD_4h.parquet", "GBPUSD_4h.parquet", "close_EURUSD", "close_GBPUSD", 1.6, 1.0),
    ("Gold/Oil", "BCOUSD_4h.parquet", "XAUUSD_4h.parquet", "close_BCOUSD", "close_XAUUSD", 3.0, 3.0),
    ("Oil/Silver", "BCOUSD_4h.parquet", "XAGUSD_4h.parquet", "close_BCOUSD", "close_XAGUSD", 3.0, 3.0),
    ("AUD/NZD", "NZDUSD_4h.parquet", "AUDUSD_4h.parquet", "close_NZDUSD", "close_AUDUSD", 2.0, 2.0),
    ("CAC/NZD", "NZDUSD_4h.parquet", "FRXEUR_4h.parquet", "close_NZDUSD", "close_FRXEUR", 3.0, 3.0),
    ("Gold/Silver", "XAUUSD_4h.parquet", "XAGUSD_4h.parquet", "close_XAUUSD", "close_XAGUSD", 3.0, 3.0),
    # Global Equities
    ("SPX/DAX", "SPXUSD_4h.parquet", "GRXEUR_4h.parquet", "close_SPXUSD", "close_GRXEUR", 3.0, 2.0),
    ("SPX/CAC", "SPXUSD_4h.parquet", "FRXEUR_4h.parquet", "close_SPXUSD", "close_FRXEUR", 3.0, 2.0),
    ("SPX/FTSE", "SPXUSD_4h.parquet", "UKXGBP_4h.parquet", "close_SPXUSD", "close_UKXGBP", 3.0, 2.0),
    ("SPX/Nikkei", "SPXUSD_4h.parquet", "JPXJPY_4h.parquet", "close_SPXUSD", "close_JPXJPY", 3.0, 2.0),
    ("SPX/HK", "SPXUSD_4h.parquet", "HKXHKD_4h.parquet", "close_SPXUSD", "close_HKXHKD", 4.0, 2.0),
    ("SPX/Dow", "SPXUSD_4h.parquet", "UDXUSD_4h.parquet", "close_SPXUSD", "close_UDXUSD", 2.0, 2.0),
    ("SPX/Nas", "SPXUSD_4h.parquet", "NSXUSD_4h.parquet", "close_SPXUSD", "close_NSXUSD", 2.0, 2.0),
    # Extended FX
    ("AUD/CAD", "AUDUSD_4h.parquet", "USDCAD_4h.parquet", "close_AUDUSD", "close_USDCAD", 2.0, 2.0),
    ("EUR/CHF", "EURUSD_4h.parquet", "USDCHF_4h.parquet", "close_EURUSD", "close_USDCHF", 2.0, 2.0),
    ("EUR/JPY", "EURUSD_4h.parquet", "USDJPY_4h.parquet", "close_EURUSD", "close_USDJPY", 2.0, 1.0),
    ("GBP/JPY", "GBPUSD_4h.parquet", "USDJPY_4h.parquet", "close_GBPUSD", "close_USDJPY", 2.0, 1.0),
    ("CHF/JPY", "USDCHF_4h.parquet", "USDJPY_4h.parquet", "close_USDCHF", "close_USDJPY", 2.0, 1.0),
    ("EUR/AUD", "EURUSD_4h.parquet", "AUDUSD_4h.parquet", "close_EURUSD", "close_AUDUSD", 2.0, 2.0),
    ("GBP/AUD", "GBPUSD_4h.parquet", "AUDUSD_4h.parquet", "close_GBPUSD", "close_AUDUSD", 2.0, 2.0),
    ("GBP/CAD", "GBPUSD_4h.parquet", "USDCAD_4h.parquet", "close_GBPUSD", "close_USDCAD", 2.0, 2.0),
    ("NZD/CAD", "NZDUSD_4h.parquet", "USDCAD_4h.parquet", "close_NZDUSD", "close_USDCAD", 2.0, 2.0),
]
...
def build_dataset():
    ...
    if len(all_events) > 0:
        ...
        out_rev = os.path.join(OUTPUT_DIR, "events_h4_8yr_v3_rev.csv")
