#!/usr/bin/env python3
"""Reconcile account risk reservations against allocator events and trade ledger."""
...
def run(
    *,
    ...
    lines: list[str] = []
    lines.append("# Account Risk Reservation Reconciliation Report")
    lines.append("")
...
def main() -> None:
    ...
    p.add_argument(
        "--out-csv",
        default="data/analysis/tick_opportunity_mining/account_risk_reservation_reconciliation.csv",
    )
