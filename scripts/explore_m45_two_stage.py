#!/usr/bin/env python3
"""
M45 two-stage exploration (MOM or REV).
...
Outputs:
- data/analysis/m45_two_stage_holdout_thresholds_<strategy>.csv
- data/analysis/m45_two_stage_wfo_thresholds_<strategy>.csv
"""
...
DATA_PATH = "data/meta_model/events_m45_8yr_v3_dual.csv"
...
def main() -> None:
    ...
    holdout_out = os.path.join(OUT_DIR, f"m45_two_stage_holdout_thresholds_{args.strategy.lower()}.csv")
    ...
    wfo_out = os.path.join(OUT_DIR, f"m45_two_stage_wfo_thresholds_{args.strategy.lower()}.csv")
    ...
    print(f"\nM45 {args.strategy} two-stage holdout (cost=5bps, selected edges):")
