    ...
    *,
    ...
    return {
        ...
        "reduced_states": _pick_first_existing(
            ...
            analysis_dir / "reduced_core" / f"{s}_oco_first_touch_reduced_states.csv",
            analysis_dir / f"reduced_core_{sl}" / f"{s}_oco_first_touch_reduced_states.csv",
        ),
