...
TARGET_DIR = "data/global_10m"


def build_all_10m_chunked():
    print("--- BUILDING GLOBAL 10M DATASET (CHUNKED MAP-REDUCE) ---")
    ...
    for asset in tqdm(assets):
        ...
        target_path = os.path.join(TARGET_DIR, f"{asset}_10m.parquet")
