#!/usr/bin/env python3
"""
M5 two-stage exploration (MOM or REV).
...
Outputs:
- data/analysis/m5_two_stage_holdout_thresholds_<strategy>.csv
- data/analysis/m5_two_stage_wfo_thresholds_<strategy>.csv
"""
...
def main() -> None:
    ...
    holdout_out = os.path.join(OUT_DIR, f"m5_two_stage_holdout_thresholds_{args.strategy.lower()}.csv")
    ...
    wfo_out = os.path.join(OUT_DIR, f"m5_two_stage_wfo_thresholds_{args.strategy.lower()}.csv")
    ...
    print(f"\nM5 {args.strategy} two-stage holdout (cost=5bps):")
