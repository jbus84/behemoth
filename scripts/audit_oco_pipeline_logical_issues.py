...
def _default_configs() -> dict[str, SymbolConfig]:
    return {
        "EURUSD": SymbolConfig(
            ...
            summary_path=Path(
                "data/analysis/tick_opportunity_mining/reduced_core_rolling/EURUSD_oco_reduced_summary.csv"
            ),
            schedule_path=Path(
                "data/analysis/tick_opportunity_mining/reduced_core_rolling/EURUSD_oco_reduced_state_schedule.csv"
            ),
            stop_detail_path=Path(
                "data/analysis/tick_opportunity_mining/stop_limit_tickfill_eurusd_fixed/EURUSD_stop_limit_tickfill_detail.csv"
            ),
            stop_caps_path=Path(
                "data/analysis/tick_opportunity_mining/stop_limit_tickfill_eurusd_fixed/EURUSD_stop_limit_tickfill_caps.csv"
            ),
        ),
        "GBPUSD": SymbolConfig(
            symbol="GBPUSD",
            ...
            summary_path=Path(
                "data/analysis/tick_opportunity_mining/reduced_core_rolling_gbpusd/GBPUSD_oco_reduced_summary.csv"
            ),
            schedule_path=Path(
        ...
        "USDJPY": SymbolConfig(
            ...
            summary_path=Path(
                "data/analysis/tick_opportunity_mining/reduced_core_rolling_usdjpy/USDJPY_oco_reduced_summary.csv"
            ),
            schedule_path=Path(
