...
PAIRS = [
    ("XAUUSD", "NSXUSD", "4h", 3.0, "Gold/Nasdaq (Tier 3)"),
    ("USDCHF", "AUDUSD", "4h", 2.0, "Swiss/Aussie (Tier 3)"),
    ("EURUSD", "AUDUSD", "4h", 2.0, "Euro/Aussie (Tier 3)"),
    ("FRXEUR", "BCOUSD", "4h", 9.0, "CAC/Oil (Tier 1 Benchmark)"),
]
