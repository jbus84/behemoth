...
| EURUSD   | C04        | pass     | medium             | overlap_diversification | median_abs_corr_diff         |       0.218898 | <=0.40                                                                             |
...
| EURUSD   | C08        | pass     | medium             | wfo_windowing           | warmup_count                 |       3        | ==3, missing_months=0, unexpected_non_ok=0                                         |
...
| GBPUSD   | C04        | pass     | medium             | overlap_diversification | median_abs_corr_diff         |       0.176459 | <=0.40                                                                             |
...
| GBPUSD   | C08        | pass     | medium             | wfo_windowing           | warmup_count                 |       3        | ==3, missing_months=0, unexpected_non_ok=0                                         |
...
| USDJPY   | C08        | pass     | medium             | wfo_windowing           | warmup_count                 |       3        | ==3, missing_months=0, unexpected_non_ok=0                                         |
