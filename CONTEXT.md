...
1. **`ModelFeatures`** (227 edges)
2. **`IncomingTick`** (154 edges)
3. **`IncomingTickBar`** (154 edges)
4. **`StateManager`** (153 edges)
5. **`.get()`** (135 edges)
6. **`BarrierManager`** (129 edges)
7. **`BarContext`** (125 edges)
8. **`BarrierAction`** (113 edges)
9. **`CandidateCatalog`** (113 edges)
