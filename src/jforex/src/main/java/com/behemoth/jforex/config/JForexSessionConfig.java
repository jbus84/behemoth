...
public record JForexSessionConfig(
    ...
    public JForexSessionConfig(
        ...
        this(
                ...
                liveWarmupTicks,
                liveLookbackDays,
                liveBridgeWindowMinutes,
                liveFreshnessSeconds,
                liveStartupBridgeTimeoutMinutes
        );
    }
    ...
    public static JForexSessionConfig fromEnvironment(boolean testerMode, Map<String, String> environment) {
        ...
        return new JForexSessionConfig(
                ...
                Boolean.parseBoolean(setting(environment, "BEHEMOTH_JFOREX_DEMO_EXECUTION_ENABLED", "true")),
